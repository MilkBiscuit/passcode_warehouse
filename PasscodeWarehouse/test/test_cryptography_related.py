...
class MyTestCase(unittest.TestCase):
    def test_given_a_message_when_encrypt_then_decrypt_returns_the_original_message(self):
        password = 'MyP@ssw0rd'
    ...
    def test_given_a_message_and_password_when_encrypt_twice_then_cipher_text_are_different(self):
        password = '123456'
        message = 'Hello'
